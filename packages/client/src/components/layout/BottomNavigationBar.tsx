    ...
    <>
      <div className="relative flex w-full items-center justify-between border-t border-t-neutral-200 px-12 py-2 sm:px-20">
        ...
        <button
          ...
          onClick={openModal}
        >
          <div className="bg-primary-200 shadow-base flex h-12 w-12 items-center justify-center rounded-lg sm:h-12 sm:w-12">
            <div className="bg-primary-500 flex h-[42px] w-[42px] items-center justify-center rounded-lg">
