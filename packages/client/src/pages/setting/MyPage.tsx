          ...
          <div className="mb-4">
            ...
            {isEdit ? (
              ...
              <div className="flex w-full justify-between">
                ...
                {userInfo?.isManager && (
                  <label className="bg-primary-coral flex items-center rounded-md px-3 py-2 text-center text-white">
                    관리자
                  </label>
                )}
              </div>
          ...
          <div className="px-6">
            ...
            <div className="mx-auto flex w-2/3 flex-col">
              ...
              <button
                ...
                className="bg-primary-coral mx-auto mt-2 flex w-full items-center justify-center rounded"
              >
